...
function _beginpage($orientation, $format)
{
	...
	if($orientation!=$this->CurOrientation || (isset($format[0]) && $format[0]!=$this->CurPageFormat[0]) || (isset($format[1]) && $format[1]!=$this->CurPageFormat[1]))
	{
		//New size
		if($orientation=='P')
		{
	...
	if($orientation!=$this->DefOrientation || ( isset($format[0]) && $format[0]!=$this->DefPageFormat[0] ) || ( isset($format[1]) && $format[1]!=$this->DefPageFormat[1]) )
